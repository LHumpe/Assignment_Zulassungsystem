"""
Django settings for InfoZulassung project.
...
INSTALLED_APPS = [
    ...
    # personal apps
    'accountspace.apps.AccountspaceConfig',
    'admissionspace.apps.AdmissionspaceConfig',
]
...
ROOT_URLCONF = 'InfoZulassung.urls'
...
WSGI_APPLICATION = 'InfoZulassung.wsgi.application'
